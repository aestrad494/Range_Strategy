...
if __name__ == '__main__':
    ...
    live_range = LiveRange(symbol=symbol, temp='1 min', client=client, verbose=True, notification=True)
    live_range.run_strategy(initial_hour='14:23:00', final_hour='14:26:00', ticks_range=1, trades_per_day=1, minutes=minutes, target=target)

    '''symbol = 'ES'
    live_range = LiveRange(symbol=symbol, temp='1 min', client=100, verbose = True, notification=True)
    live_range.run_strategy(initial_hour='14:14:00', final_hour='14:16:00', ticks_range=5, trades_per_day=1, minutes=1, target=0.5)'''